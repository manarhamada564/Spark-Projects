...
public class LogisticRegressionExample {
	...
	public static void main(String[] args) {
		...
		Dataset<Row> treatmentDf = spark.read()
				...
				.format("csv")
				.load("E:/Data-Engineering/Spark/udemy/cryotherapy.csv");
		...
		StringIndexer genderIndexer = new StringIndexer()
				.setInputCol("sex").setOutputCol("sexIndex");//convert category values to num
	
		VectorAssembler assembler = new VectorAssembler()
				.setInputCols(new String [] {"sexIndex", "age", "time", "number_of_warts", "type", "area"})
				.setOutputCol("features");//wanna connect genderIndexer with features in pipeline
