...
//    	customersDf.join(purchasesDf,
//    			customersDf.col("customer_id").equalTo(purchasesDf.col("customer_id")))
//    	.join(productsDf, purchasesDf.col("product_id").equalTo(purchasesDf.col("customer_id"))).show();
	   ...
	   for(int i = 0; i < 500; i++ ) { //rm all above no action
